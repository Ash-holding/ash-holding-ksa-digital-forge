...
import {
  ...
  Megaphone, Server, GraduationCap, Search, Compass, PenTool, Wrench, TestTube2,
  Rocket, HeadphonesIcon, ShieldCheck, Globe, Layers, Cpu, Cloud, Database, Mail,
  BarChart3, Target, FileText, Wallet, Receipt, FileSignature, LifeBuoy, FolderKanban,
  CircleDollarSign, MapPin, Check
} from "lucide-react";
...
export function Hero() {
  ...
  // Positioned around hero (RTL-safe percentages)
  const positions = [
    "top-[8%] right-[6%]", "top-[18%] left-[8%]", "top-[38%] right-[2%]",
    "top-[55%] left-[4%]", "top-[72%] right-[10%]", "top-[12%] left-[35%]",
    "top-[80%] left-[30%]", "top-[30%] left-[22%]", "top-[62%] right-[22%]",
  ];
  return (
    <section id="home" className="relative min-h-screen bg-hero pt-28 md:pt-36 pb-20 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 md:px-8 text-center">
        ...
        >
          ...
          شركة سعودية للحلول الرقمية المتكاملة
        </motion.div>

        <motion.h1
          initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }}
          className="text-4xl md:text-6xl lg:text-7xl font-bold leading-[1.15] tracking-tight"
        >
          حلول رقمية متكاملة
          <br />
        ...
        <motion.p
          ...
          className="mt-6 text-base md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed"
        >
          من الفكرة إلى النظام الكامل، نطوّر مواقع، تطبيقات، منصات، استضافة، تسويق،
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8 grid lg:grid-cols-2 gap-14 items-center">
        <div>
          ...
          <p className="mt-5 text-muted-foreground leading-relaxed md:text-lg">
            في <b>ASH HOLDING</b> نجمع بين الهندسة البرمجية المتقدمة والفهم العميق للسوق السعودي
            لنقدّم لعملائنا منصات وأنظمة رقمية تتوافق مع أعلى المعايير المؤسسية. نعمل كشريك
            استراتيجي طويل الأمد لبناء منتجات قابلة للتوسع.
          </p>
          ...
          >
            <div className="h-full w-full p-5 flex flex-col">
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
                ...
                <span className="mr-auto">ash-dashboard.tsx</span>
              </div>
...
export function Services() {
  const items = [
    { icon: Code2, title: "تطوير المواقع", desc: "مواقع مؤسسية ومنصات ويب عالية الأداء بتقنيات حديثة.", color: "electric" },
    { icon: Smartphone, title: "تطبيقات الجوال", desc: "تطبيقات iOS و Android أصلية وهجينة بتجربة سلسة.", color: "cyan-accent" },
    { icon: LayoutDashboard, title: "الأنظمة ولوحات التحكم", desc: "أنظمة إدارية مخصصة تربط عملياتك في مكان واحد.", color: "purple-accent" },
    { icon: Brain, title: "الذكاء الاصطناعي والأتمتة", desc: "حلول AI تختصر الوقت وتزيد كفاءة اتخاذ القرار.", color: "orange-accent" },
    { icon: Palette, title: "التصميم والهوية", desc: "هويات بصرية وواجهات UI/UX تنقل قيمة علامتك.", color: "electric" },
    { icon: Megaphone, title: "التسويق الرقمي", desc: "استراتيجيات سيو وإعلانات وحملات مدفوعة بالنتائج.", color: "cyan-accent" },
  ];
  return (
    <section id="services" className="relative py-24 md:py-32 bg-secondary/40">
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="text-3xl md:text-5xl font-bold">خدمات شاملة تحت سقف واحد</h2>
          <p className="mt-4 text-muted-foreground md:text-lg">مجموعة متكاملة تغطي كل مراحل التحول الرقمي لمؤسستك.</p>
        </div>
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((s, i) => (
            <motion.div
              ...
              className="group relative rounded-3xl border border-border bg-card p-7 shadow-card hover:shadow-glow hover:-translate-y-1 transition-all overflow-hidden"
            >
              ...
              <div className={`relative grid h-14 w-14 place-items-center rounded-2xl bg-${s.color}/10 text-${s.color} mb-5 group-hover:scale-110 transition`}>
              ...
              <div className="relative mt-5 flex items-center gap-1 text-xs font-semibold text-electric">
    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 md:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold">من الفكرة إلى الإطلاق بخطوات مدروسة</h2>
        </div>
            ...
            {steps.map((s, i) => (
              ...
              >
                <div className="relative mx-auto grid h-16 w-16 place-items-center rounded-2xl bg-brand text-primary-foreground shadow-glow">
                  <s.icon className="h-7 w-7" />
                  <div className="absolute -top-2 -right-2 grid h-6 w-6 place-items-center rounded-full bg-card border border-border text-[10px] font-bold">{i + 1}</div>
                </div>
...
export function Products() {
  const items = [
    { name: "ASH Client OS", status: "نشط", desc: "نظام إدارة العملاء والمشاريع والفواتير والعقود.", icon: LayoutDashboard },
    { name: "ASH Web AI", status: "نشط", desc: "منصة توليد وتشغيل مواقع ذكية بمساعدة الذكاء الاصطناعي.", icon: Brain },
    { name: "ASH Stream", status: "قريباً", desc: "منصة بث ومحتوى مرئي متكاملة عالية الأداء.", icon: Globe },
    { name: "ASH Stores", status: "نشط", desc: "بنية متاجر إلكترونية جاهزة للسوق السعودي.", icon: Layers },
    { name: "Numaxio", status: "نشط", desc: "نظام محاسبي ومالي متوافق مع الأنظمة المحلية.", icon: CircleDollarSign },
    { name: "DigiMart", status: "نشط", desc: "سوق رقمي للمنتجات والخدمات القابلة للتوسع.", icon: Target },
    { name: "Student OS", status: "قريباً", desc: "نظام متكامل لخدمات الطلاب الجامعيين.", icon: GraduationCap },
  ];
  return (
    <section id="products" className="py-24 md:py-32 bg-secondary/40">
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <div className="flex flex-wrap items-end justify-between gap-4 mb-12">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full bg-card px-3 py-1 text-xs font-medium mb-3 border border-border">منتجاتنا</div>
            <h2 className="text-3xl md:text-5xl font-bold max-w-2xl">منصات جاهزة تخدم قطاعات متعددة</h2>
          </div>
          <a href="#" className="text-sm font-semibold text-electric inline-flex items-center gap-1">جميع المنتجات <ArrowLeft className="h-4 w-4" /></a>
        </div>
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {items.map((p, i) => (
            <motion.div
              key={p.name}
              initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }}
              className="group relative rounded-3xl border border-border bg-card p-6 shadow-card hover:shadow-glow hover:-translate-y-1 transition-all"
            >
              <div className="flex items-start justify-between">
                <div className="grid h-12 w-12 place-items-center rounded-2xl bg-brand text-primary-foreground">
                  <p.icon className="h-6 w-6" />
                </div>
                <span className={`text-[10px] font-bold px-2.5 py-1 rounded-full ${p.status === "نشط" ? "bg-cyan-accent/15 text-cyan-accent" : "bg-orange-accent/15 text-orange-accent"}`}>{p.status}</span>
              </div>
              <div className="mt-5 text-lg font-bold">{p.name}</div>
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">{p.desc}</p>
              <a href="#" className="mt-5 inline-flex items-center gap-1 text-sm font-semibold text-electric">اعرف أكثر <ArrowLeft className="h-4 w-4" /></a>
            </motion.div>
          ))}
        </div>
      </div>
...
export function Hosting() {
  const items = [
    { icon: Server, t: "استضافة مشتركة", d: "بيئة سريعة ومحمية للمواقع والمنصات الصغيرة والمتوسطة." },
    { icon: Cpu, t: "خوادم VPS", d: "أداء مخصص ومرونة كاملة في إدارة الموارد." },
    { icon: Database, t: "سيرفرات مخصصة", d: "بنية تحتية مؤسسية للتطبيقات الحساسة." },
    { icon: Wrench, t: "إدارة السيرفرات", d: "مراقبة ٢٤/٧، تحديثات وأمان مستمر." },
    { icon: Mail, t: "البريد و SMTP", d: "حلول بريد احترافية بأعلى معدلات وصول." },
    { icon: Cloud, t: "بنية سحابية", d: "توسع مرن يواكب نمو عملك بلا حدود." },
  ];
  return (
    <section id="hosting" className="relative py-24 md:py-32 bg-dark text-primary-foreground overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 md:px-8">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="text-3xl md:text-5xl font-bold">بنية تحتية موثوقة تعمل بلا توقف</h2>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((h, i) => (
            <motion.div
              key={h.t}
              initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }}
              className="glass-dark rounded-3xl p-7 hover:bg-white/10 transition"
            >
              <div className="grid h-12 w-12 place-items-center rounded-2xl bg-electric/20 text-electric-soft mb-5">
                <h.icon className="h-6 w-6" />
              </div>
              <div className="text-lg font-bold">{h.t}</div>
...
export function Marketing() {
  const items = [
    ...
    { icon: Target, t: "الإعلانات المدفوعة", d: "حملات ذكية على قوقل وميتا وتيك توك." },
    { icon: BarChart3, t: "إدارة الحملات", d: "تخطيط، تنفيذ، تحليل وتحسين مستمر." },
    { icon: FileText, t: "الهوية والمحتوى", d: "محتوى عربي احترافي يعكس صوت علامتك." },
  ];
  return (
    <section id="marketing" className="py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-4 md:px-8 grid lg:grid-cols-[1fr_1.4fr] gap-12 items-start">
        <div>
          ...
          <h2 className="text-3xl md:text-5xl font-bold leading-tight">نموّك الرقمي مبني على البيانات</h2>
          <p className="mt-5 text-muted-foreground md:text-lg leading-relaxed">
            فريق تسويق متخصص يعمل بالأرقام والتحليلات لتحويل الزيارات إلى عملاء،
            والحملات إلى نتائج قابلة للقياس.
          </p>
          <div className="mt-6 rounded-3xl bg-brand p-6 text-primary-foreground shadow-glow">
            <div className="text-4xl font-bold">+320%</div>
            <div className="text-sm opacity-80 mt-1">متوسط نمو تحويلات عملائنا خلال ٦ أشهر</div>
          </div>
        </div>
...
export function ClientPortal() {
  const cards = [
    ...
    { icon: LifeBuoy, t: "الدعم", v: "2", c: "orange-accent" },
    { icon: Sparkles, t: "الاشتراكات", v: "4", c: "electric" },
    { icon: Wallet, t: "المحفظة", v: "12,450 ﷼", c: "cyan-accent" },
  ];
  return (
    <section id="portal" className="py-24 md:py-32 bg-secondary/40">
      <div className="mx-auto max-w-7xl px-4 md:px-8 grid lg:grid-cols-2 gap-14 items-center">
        <div>
          ...
          <h2 className="text-3xl md:text-5xl font-bold leading-tight">
            بوابة العميل — <span className="gradient-text">تحكم كامل</span> في كل ما يخصك
          </h2>
          <p className="mt-5 text-muted-foreground md:text-lg leading-relaxed">
            نظام موحد للمشاريع، الفواتير، العقود، الاشتراكات، الدعم والمحفظة —
            بواجهة عربية سلسة تعمل على جميع الأجهزة.
          </p>
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <a href="#" className="rounded-xl border border-border bg-card px-5 py-3 text-sm font-semibold">فتح حساب جديد</a>
          </div>
        </div>
        <motion.div
          initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
        ...
        >
          <div className="flex items-center justify-between border-b border-border pb-3">
            <div className="flex items-center gap-2">
              ...
              <div className="text-sm font-bold">لوحة تحكم العميل</div>
            </div>
          ...
          <div className="mt-5 grid grid-cols-2 sm:grid-cols-3 gap-3">
            {cards.map((c) => (
              <div key={c.t} className={`rounded-2xl bg-${c.c}/5 border border-${c.c}/20 p-4`}>
                <div className={`grid h-9 w-9 place-items-center rounded-xl bg-${c.c}/15 text-${c.c} mb-3`}>
...
export function Why() {
  const items = [
    ...
    { icon: Globe, t: "أنظمة عربية أولاً", d: "تصميم وتجربة استخدام RTL أصيلة." },
    { icon: Code2, t: "تطوير مخصص", d: "حلول مبنية على متطلباتك، لا قوالب جاهزة." },
    { icon: FileSignature, t: "عقود واضحة", d: "شفافية كاملة في النطاق والأسعار." },
    { icon: HeadphonesIcon, t: "دعم بعد الإطلاق", d: "متابعة، صيانة وتحديثات مستمرة." },
    { icon: Cloud, t: "بنية قابلة للتوسع", d: "بنية سحابية تنمو مع عملك." },
  ];
  return (
    <section id="vision" className="py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="text-3xl md:text-5xl font-bold">شريك تقني تثق به المؤسسات</h2>
        </div>
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((w, i) => (
            <motion.div
        ...
        <div className="relative overflow-hidden rounded-[2rem] bg-dark px-8 md:px-16 py-16 md:py-24 text-primary-foreground text-center shadow-glow">
          ...
          <div className="relative">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight">
              جاهز لتحويل فكرتك إلى <span className="gradient-text">منصة حقيقية؟</span>
            </h2>
            <p className="mt-5 text-white/70 max-w-2xl mx-auto md:text-lg">
              تحدث مع فريقنا اليوم واحصل على استشارة أولية مجانية لمشروعك.
            </p>
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              <a href="#portal" className="rounded-xl glass-dark text-white px-6 py-3.5 text-sm font-semibold hover:bg-white/10 transition">افتح حساب عميل</a>
            </div>
          </div>
        </div>
      </div>
