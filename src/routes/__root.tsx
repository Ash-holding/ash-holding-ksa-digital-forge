...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ASH HOLDING — حلول رقمية متكاملة" },
      { property: "og:description", content: "من الفكرة إلى النظام الكامل: مواقع، تطبيقات، منصات، استضافة، تسويق ولوحات تشغيل." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://cdn.jsdelivr.net/npm/saudi-riyal-symbol@1.0.3/dist/saudi-riyal-symbol.min.css" },
